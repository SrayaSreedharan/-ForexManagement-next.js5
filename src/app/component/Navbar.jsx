...
const Navbar = ({ activeContent, setActiveContent }) => {
  const navItems = [
  ...
  { label: "Reconciliation", id: "reconciliation", icon: <ReceiptLongIcon /> },
    ...
    <AppBar position="static" color="inherit" elevation={1} sx={{ bgcolor: "#fafafa", color: "text.primary" }}>
      <Toolbar sx={{ display: "flex", justifyContent: "space-between" }}>
        <Box display="flex" alignItems="center" gap={1}>
          ...
          <Box>
            <Typography variant="h6" fontWeight="bold">Inventory Management Platform</Typography>
            <Typography variant="body2" color="text.secondary">Administrator Dashboard</Typography>
          </Box>
        </Box>
            ...
            return (
              <Button
                ...
                sx={{
                  textTransform: "none",
                  ...(active
                    ? { bgcolor: "orange", color: "black", "&:hover": { bgcolor: "darkorange" } }
                    : {}),
                }}
              >
                {label}
